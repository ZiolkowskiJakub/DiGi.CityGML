...
**DiGi.CityGML** is a C# engineering and architectural software library suite designed for BIM and CAD integrations (such as Revit, RhinoCommon, Grasshopper, and Dynamo BIM).
...
* **[DiGi.CityGML.Test](DiGi.CityGML.Test)** (Path: `DiGi.CityGML\DiGi.CityGML.Test`)
* **[DiGi.CityGML](DiGi.CityGML)** (Path: `DiGi.CityGML\DiGi.CityGML`)
